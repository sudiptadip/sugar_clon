...
import { Box, Flex, Text, UnorderedList, ListItem, useToast } from "@chakra-ui/react";
...
export default function MakeupIndividual() {
  ...
  useEffect(() => {
    // getData();
    axios
      .get(`https://gearbest-database.onrender.com/makeup/${id}`)
        ...
        <Flex>
          ...
          <Flex m="20px" p="10px" flexDirection="column" gap="10px">
            ...
            <Box w="fit-content" display="flex" gap="10px" m="10px 0px">
              ...
              <button
                onClick={() => {dispatch(addToCart(payload)); toast({
