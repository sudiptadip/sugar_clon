...
function Face() {
  ...
  useEffect(() => {
    let url = "https://gearbest-database.onrender.com/face";
    if (prod.length !== 0 && order.length !== 0)
      url = `https://gearbest-database.onrender.com/face?_sort=price&_order=${order}&q=${prod}`;
    else if (prod.length !== 0)
      url = `https://gearbest-database.onrender.com/face?q=${prod}`;
    else if (order.length !== 0)
      url = `https://gearbest-database.onrender.com/face?_sort=price&_order=${order}`;
