...
function Lips() {
  ...
  useEffect(() => {
    let url = "https://gearbest-database.onrender.com/lips";
    if (prod.length !== 0 && order.length !== 0)
      url = `https://gearbest-database.onrender.com/lips?_sort=price&_order=${order}&q=${prod}`;
    else if (prod.length !== 0)
      url = `https://gearbest-database.onrender.com/lips?q=${prod}`;
    else if (order.length !== 0)
      url = `https://gearbest-database.onrender.com/lips?_sort=price&_order=${order}`;
